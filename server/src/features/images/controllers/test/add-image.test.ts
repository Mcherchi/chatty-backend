...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    it('should call image upload method', async () => {
      ...
      await AddImage.prototype.profileImage(req, res);
    ...
    it('should call updateSingleUserItemInCache method', async () => {
      ...
      jest.spyOn(cloudinaryUploads, 'upload').mockImplementation((): any =>
        Promise.resolve({
          version: '1234',
          public_id: '123456',
          secure_url: 'https://res.cloudinary.com/dyamr9ym3/image/upload/v1234/123456'
        })
      );
  ...
  describe('backgroundImage', () => {
    it('should upload new image', async () => {
      ...
      await AddImage.prototype.backgroundImage(req, res);
    ...
    it('should return bad request error', async () => {
      ...
      AddImage.prototype.backgroundImage(req, res).catch((error: CustomError) => {
